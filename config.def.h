...
static const char *fonts[] = {
    "FiraCode Nerd Font:style:medium:size=10",
...
static char dmenumon[2] =
    "0"; /* component of jmenucmd, manipulated in spawn() */
...
static Key keys[] = {
    ...
    TAGKEYS(XK_ampersand, 0) TAGKEYS(XK_eacute, 1) TAGKEYS(XK_quotedbl, 2)
        TAGKEYS(XK_apostrophe, 3) TAGKEYS(XK_parenleft, 4) TAGKEYS(XK_minus, 5)
            TAGKEYS(XK_egrave, 6) TAGKEYS(XK_underscore, 7)
                TAGKEYS(XK_ccedilla, 8){MODKEY, XK_ccedilla, view, {.ui = ~0}},
    ...
    {MODKEY, XK_F11, spawn,
     SHCMD("mpv --no-cache --no-osc --no-input-default-bindings "
           ...
           "tail -n 1)")},
    {MODKEY, XK_F12, spawn,
     SHCMD("remaps & notify-send \\\"Clavier remappé\\\"")},
